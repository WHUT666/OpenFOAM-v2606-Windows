...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.2.1/Shape_detection/include/CGAL/Shape_detection/Region_growing/Polygon_mesh/Polyline_graph.h $
// $Id: include/CGAL/Shape_detection/Region_growing/Polygon_mesh/Polyline_graph.h 28811b671a1 $
...
public:
  ...
  using Item = typename boost::graph_traits<PolygonMesh>::edge_descriptor;
    ...
    /*!
      ...
      value type is `edge_descriptor` of the `PolygonMesh` (`boost::graph_traits<PolygonMesh>::edge_descriptor`).
    */
    typedef unspecified_type Segment_range;

    /*!
      a model of `ReadablePropertyMap` whose key type is the value type of `Segment_range`
      and value type is `Segment_3` from the \cgal %Kernel used by `VertexPointMap`.
    */
...
public:
  ...
  /*!
    ...
    (`boost::graph_traits<PolygonMesh>::face_descriptor`) and value type is `std::size_t`
    ...
    \cgalNamedParamsBegin
      \cgalParamNBegin{vertex_point_map}
        ...
        vertex (`boost::graph_traits<PolygonMesh>::vertex_descriptor`) to `Point_3` from a \cgal %Kernel}
  ...
  */
  ...
  /*!
    ...
    \tparam EdgeRange a model of `ConstRange` with `edge_descriptor`
  ...
  */
  ...
  /*!
    ...
    to `Segment_3` from the \cgal %Kernel used by `VertexPointMap`.
  */
