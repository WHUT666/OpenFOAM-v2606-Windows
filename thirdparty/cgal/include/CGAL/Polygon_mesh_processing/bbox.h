...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.2.1/Polygon_mesh_processing/include/CGAL/Polygon_mesh_processing/bbox.h $
// $Id: include/CGAL/Polygon_mesh_processing/bbox.h 28811b671a1 $
                          ...
                          const NamedParameters& np = parameters::default_values())
{
  ...
  CGAL_precondition(is_valid_vertex_descriptor(vd, pmesh));
              ...
              const NamedParameters& np = parameters::default_values())
{
  ...
  typename GT::Construct_iso_cuboid_3 iso_cuboid = gt.construct_iso_cuboid_3_object();
