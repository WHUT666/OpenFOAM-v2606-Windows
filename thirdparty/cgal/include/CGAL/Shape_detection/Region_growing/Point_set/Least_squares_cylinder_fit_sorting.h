...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.2.1/Shape_detection/include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_cylinder_fit_sorting.h $
// $Id: include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_cylinder_fit_sorting.h 28811b671a1 $
...
/*!
  ...
  \tparam PointMap
  a model of `ReadablePropertyMap` whose key type `Item` and value type is `GeomTraits::Point_3`

  \tparam NormalMap
  a model of `ReadablePropertyMap` whose key type is `Item` and value type is `GeomTraits::Vector_3`
*/
