...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.2.1/Shape_detection/include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_circle_fit_region.h $
// $Id: include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_circle_fit_region.h 28811b671a1 $
...
/*!
  ...
  \tparam PointMap
  a model of `ReadablePropertyMap` whose key type is `Item` and value type is `GeomTraits::Point_2`

  \tparam NormalMap
  a model of `ReadablePropertyMap` whose key type is `Item` and value type is `GeomTraits::Vector_2`
  ...
  /*!
    ...
    \cgalNamedParamsBegin
      ...
      \cgalParamNBegin{point_map}
        \cgalParamDescription{an instance of `PointMap` that maps an item to `GeomTraits::Point_2`}
        \cgalParamDefault{`PointMap()`}
      \cgalParamNEnd
      \cgalParamNBegin{normal_map}
        \cgalParamDescription{an instance of `NormalMap` that maps an item to `GeomTraits::Vector_2`}
