...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.2.1/PMP_Remeshing/include/CGAL/Polygon_mesh_processing/angle_and_area_smoothing.h $
// $Id: include/CGAL/Polygon_mesh_processing/angle_and_area_smoothing.h 28811b671a1 $
...
void angles_evaluation(const TriangleMesh& tmesh, GeomTraits traits, Stream& output)
{
...
template<typename TriangleMesh, typename GeomTraits, typename Stream>
void areas_evaluation(const TriangleMesh& tmesh, GeomTraits traits, Stream& output)
{
  internal::Quality_evaluator<TriangleMesh, GeomTraits> evaluator(tmesh, traits);
...
template<typename TriangleMesh, typename GeomTraits, typename Stream>
void aspect_ratio_evaluation(const TriangleMesh& tmesh, GeomTraits traits, Stream& output)
{
  internal::Quality_evaluator<TriangleMesh, GeomTraits> evaluator(tmesh, traits);
