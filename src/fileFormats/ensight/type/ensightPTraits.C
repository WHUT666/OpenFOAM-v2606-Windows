...
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<Foam::label>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<float>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<double>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<Foam::vector>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<Foam::sphericalTensor>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<Foam::symmTensor>);
fileFormats_TEMPLATE_EXPORT(Foam::ensightPTraits<Foam::tensor>);
