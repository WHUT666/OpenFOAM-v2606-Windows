...
#ifdef _MSC_VER
/* MSVC/UCRT has no drand48 family - provided by msvc_drand48.c */
void srand48(long seed);
double drand48(void);
#endif

/* errexit() also exists in vendored metis - rename to avoid a duplicate
   definition when both libraries end up in the same link */
#define errexit mgridgen_errexit
