...
**Feature type (please check all that apply):**
...
- Priority: "Nice to have", "Important", "Urgent" etc.
...
- Comparison: How does this differ from the current approach? Illustrations etc.
- Alternatives: What are the alternatives to the proposal?
